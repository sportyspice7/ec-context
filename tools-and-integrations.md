# Tools & Integrations — Tanja / ExploreClairemont

## Overview
These are the third-party tools Tanja uses to run ExploreClairemont.com and related operations. Understanding these helps Claude give relevant advice without suggesting tools she already has.
...
- **CDN Cache** — site performance/caching
- **Advanced Themer** — theme customization
